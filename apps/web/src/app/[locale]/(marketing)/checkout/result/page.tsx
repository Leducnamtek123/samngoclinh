  ...
  return (
    <div className="flex min-h-[70vh] w-full items-center justify-center bg-gray-50 px-4 py-16">
      <div className="w-full max-w-md space-y-5 rounded-3xl bg-white p-8 text-center shadow-xl">
        ...
        {kind === 'success' &&
          (hasContract ? (
            <div className="space-y-2.5 rounded-2xl border border-emerald-200 bg-emerald-50/70 p-4 text-left">
              ...
              <Link
                className="mt-2 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-700 py-2.5 text-xs font-bold text-white shadow-xs transition-colors hover:bg-emerald-800 sm:text-sm"
            ...
            <div className="space-y-1.5 rounded-2xl border border-gray-100 bg-gray-50 p-4 text-left">
              <div className="flex items-center gap-2 text-sm font-bold text-gray-800">
                <Package className="h-4 w-4 shrink-0 text-gray-600" />
                <span>{t('packingShipping')}</span>
              </div>
              <p className="text-xs leading-relaxed text-gray-600">{t('packingShippingDesc')}</p>
            </div>
          ))}
