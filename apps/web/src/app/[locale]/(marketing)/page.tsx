  ...
  return (
    <section className="py-20 bg-white relative overflow-hidden">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .animate-float-2 { animation: float 6s ease-in-out infinite 0.8s; }
        .animate-float-3 { animation: float 6s ease-in-out infinite 1.6s; }
        .animate-float-4 { animation: float 6s ease-in-out infinite 2.4s; }
        .animate-gradient-text { background-size: 200% auto; animation: shine 4s linear infinite; }
      `}} />

      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          <div className="lg:col-span-5 relative group animate-fade-in-up">
            <div className="relative aspect-[4/3] sm:aspect-[16/10] lg:aspect-[4/5] rounded-3xl overflow-hidden shadow-lg border border-gray-100 bg-gray-50 max-h-[520px]">
              <Image 
