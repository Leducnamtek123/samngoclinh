...
const RANK_CONFIGS: Record<MemberRankType, RankConfig> = {
  bronze: {
    ...
    bgGradient:
      'bg-gradient-to-r from-amber-900/10 via-amber-700/10 to-amber-950/10 dark:from-amber-950/40 dark:to-amber-900/20',
  ...
  silver: {
    ...
    bgGradient:
      'bg-gradient-to-r from-slate-200/50 via-slate-100/50 to-slate-300/30 dark:from-slate-800 dark:to-slate-900',
  ...
  gold: {
    ...
    bgGradient:
      'bg-gradient-to-r from-yellow-100/80 via-amber-100/60 to-yellow-200/40 dark:from-yellow-950/50 dark:to-amber-950/30',
  ...
  diamond: {
    ...
    bgGradient:
      'bg-gradient-to-r from-sky-100/80 via-cyan-100/60 to-sky-200/40 dark:from-sky-950/50 dark:to-cyan-950/30',
  ...
  vip: {
    ...
    bgGradient:
      'bg-gradient-to-r from-emerald-100/90 via-teal-100/70 to-emerald-200/50 dark:from-emerald-950/60 dark:to-teal-950/40',
...
const normalizeRank = (rawRank?: string): MemberRankType => {
  ...
  if (lower.includes('vip') || lower.includes('tinh hoa') || lower.includes('elite')) {
    return 'vip';
  }
...
export const MemberRankBadge: React.FC<MemberRankBadgeProps> = ({
  ...
  return (
    <div
      className={`inline-flex items-center rounded-full border font-extrabold shadow-2xs transition-transform hover:scale-105 ${config.bgGradient} ${config.textColor} ${config.borderColor} ${currentSize.textClass} ${className}`}
    >
