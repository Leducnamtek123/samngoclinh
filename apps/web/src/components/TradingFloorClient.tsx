      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 py-8 space-y-6">
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start animate-pulse">
            <div className="lg:col-span-8 bg-white border border-gray-200 rounded-2xl h-96"></div>
            <div className="lg:col-span-4 bg-white border border-gray-200 rounded-2xl h-96"></div>
          </div>
        ) : isError ? (
          <div className="bg-red-50 border border-red-200 text-red-700 p-8 rounded-2xl text-center font-medium">
            Có lỗi xảy ra khi tải dữ liệu sàn giao dịch. Vui lòng tải lại trang.
          </div>
        ) : (
