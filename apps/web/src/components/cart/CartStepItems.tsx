    ...
    <>
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="flex items-center justify-between border-b border-gray-100 pb-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="font-extrabold text-gray-900 text-lg flex items-center gap-2">
                ...
                <span>Sản phẩm trong giỏ ({selectedItems.length}/{items.length} chọn)</span>
              </h2>
            </div>
            <button
              type="button"
            ...
            {items.map((item) => {
              ...
              return (
                <div key={item.id} className="py-4 flex items-center gap-4 group">
                  ...
                  <Link
                    href={detailUrl}
                    className="relative w-20 h-20 rounded-2xl bg-gray-50 flex items-center justify-center p-2 border border-gray-150 flex-shrink-0 overflow-hidden group-hover:border-emerald-300 transition-colors"
                  >
                    <Image
                  ...
                  <div className="flex-1 min-w-0 space-y-1">
                    <Link
                      href={detailUrl}
                      className="font-bold text-gray-900 text-sm truncate block hover:text-emerald-700 transition-colors"
                    >
                      {item.name}
                    </Link>
        ...
        <div className="lg:col-span-4 bg-white border border-gray-200 rounded-3xl p-6 shadow-sm space-y-6">
          <h3 className="font-extrabold text-gray-900 text-base border-b border-gray-100 pb-3">Tạm tính ({selectedItems.length} mặt hàng chọn)</h3>
