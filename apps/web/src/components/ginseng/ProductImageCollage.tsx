    ...
    return (
      <div className="w-full h-full grid grid-cols-2 gap-1 rounded-xl overflow-hidden bg-gray-100 p-0.5">
        <div className="h-full w-full relative overflow-hidden rounded-l-lg">
          <Image src={images[0]!} alt={item.name} fill sizes="(max-width: 768px) 100vw, 33vw" unoptimized className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
        </div>
        <div className="h-full w-full relative overflow-hidden rounded-r-lg">
          <Image src={images[1]!} alt={`${item.name} 2`} fill sizes="(max-width: 768px) 100vw, 33vw" unoptimized className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
        </div>
      </div>
    );
  }
      ...
      <div className="w-full h-full grid grid-cols-2 gap-1 rounded-xl overflow-hidden bg-gray-100 p-0.5">
        ...
        <div className="grid grid-rows-2 gap-1 h-full w-full">
          ...
          <div className="h-full w-full relative overflow-hidden rounded-br-lg">
            <Image src={images[2]!} alt={`${item.name} 3`} fill sizes="(max-width: 768px) 100vw, 33vw" unoptimized className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
          </div>
        </div>
      </div>
    );
  ...
  if (count === 4) {
    return (
      <div className="w-full h-full grid grid-cols-2 grid-rows-2 gap-1 rounded-xl overflow-hidden bg-gray-100 p-0.5">
        ...
        <div className="h-full w-full relative overflow-hidden rounded-br-lg">
          <Image src={images[3]!} alt={`${item.name} 4`} fill sizes="(max-width: 768px) 100vw, 33vw" unoptimized className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
        </div>
      </div>
    );
  }
