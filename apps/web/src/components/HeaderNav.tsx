    ...
    <>
      ...
      <li className="flex items-center">
        <Link
          ...
          className={`h-8 px-3 rounded-full inline-flex items-center justify-center gap-1.5 text-xs font-bold leading-none transition-all whitespace-nowrap flex-shrink-0 border ${
      ...
      <li className="relative group flex items-center">
        ...
        {/* Dropdown Menu */}
        <div className="absolute left-0 top-full mt-1 w-52 rounded-2xl bg-white border border-gray-100 shadow-xl p-1.5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 flex flex-col gap-1">
          <Link
            href="/news"
            className={`px-3.5 py-2 text-[13px] font-semibold transition-all duration-150 block whitespace-nowrap ${
