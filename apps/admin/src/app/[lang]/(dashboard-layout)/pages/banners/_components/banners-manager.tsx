...
function BannersTable({ sortedBanners, pageNameMap, handleEditClick, setDeletingId }: BannersTableProps) {
  return (
              ...
              <TableRow key={banner.id} className="hover:bg-slate-50/50">
                ...
                <TableCell>
                  <div className="w-24 h-14 rounded-lg overflow-hidden border border-slate-200 bg-slate-50 relative flex items-center justify-center">
                    {banner.image ? (
                      <Image src={banner.image} alt="Preview" fill sizes="96px" unoptimized className="object-cover" />
                    ) : (
      ...
      <DialogContent className="sm:max-w-xl">
        ...
        <form onSubmit={handleSave} className="space-y-4 py-2">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-4 items-center">
              <div className="w-32 h-20 bg-slate-100 rounded-lg border border-slate-200 overflow-hidden relative flex items-center justify-center flex-shrink-0">
                {formData.image ? (
                  <Image src={formData.image} alt="Preview" fill sizes="128px" unoptimized className="object-cover" />
                ) : (
          ...
          <DialogFooter className="pt-4 border-t border-slate-100 gap-2">
            <Button type="button" variant="outline" onClick={() => onOpenChange(false)} disabled={dialogLoading}>
              Hủy bỏ
            </Button>
