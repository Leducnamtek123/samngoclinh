...
import { ShieldCheck, Check, Copy, Clock, FileEdit, Send, CheckCircle2 } from "lucide-react"
      ...
      <Card className="border-border/80 shadow-xs">
        <CardHeader className="pb-3">
          <CardTitle className="text-sm font-bold flex items-center gap-2">
            <Clock className="w-4 h-4 text-emerald-600" /> Tiến trình hợp đồng
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="relative pl-6 space-y-4 border-l-2 border-slate-200 dark:border-slate-800 ml-2">
            ...
            <div className="relative">
              ...
              <div>
                <h5 className="font-bold text-xs text-slate-900 dark:text-white">1. Khởi tạo hợp đồng</h5>
            ...
            <div className="relative">
              ...
              <div>
                <h5 className="font-bold text-xs text-slate-900 dark:text-white">
                  {isDraft ? "2. BQL đang rà soát & cá nhân hóa" : "2. BQL đã phát hành hợp đồng"}
                </h5>
                <p className="text-[11px] text-muted-foreground">
                  {isDraft
                    ? "Admin đang kiểm tra thông tin khách hàng và tinh chỉnh các biến số trong hợp đồng."
                    : "Đã phê duyệt nội dung và kích hoạt gửi thông báo cho khách hàng."}
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div>
                <h5 className="font-bold text-xs text-slate-900 dark:text-white">
                  {isSigned
                    ? "3. Khách hàng đã ký điện tử"
                    : isPending
                    ? "3. Chờ khách hàng ký số"
                    : "3. Chờ gửi khách ký"}
                </h5>
                <p className="text-[11px] text-muted-foreground">
                  {isSigned && contract.signedAt
                    ...
                    : isPending
                    ? "Đang chờ khách hàng xác nhận chữ ký 1-Click trên Web/App."
                    : "Sẽ bắt đầu sau khi BQL bấm 'Phát hành & Gửi khách ký'."}
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div>
                <h5 className="font-bold text-xs text-slate-900 dark:text-white">
                  {isSigned ? "4. Hợp đồng có hiệu lực pháp lý" : "4. Thời hạn hiệu lực"}
                </h5>
                <p className="text-[11px] text-muted-foreground">
