...
export function LineCharts() {
  ...
  return (
    <section className="conatiner grid gap-4 p-4">
      <BasicLineChart recharts={recharts} />
      <TinyLineChart recharts={recharts} />
      <DashedLineChart recharts={recharts} />
      <VerticalLineChart recharts={recharts} />
      <BiaxialLineChart recharts={recharts} />
      <VerticalLineChartDomain recharts={recharts} />
      <LineChartPadding recharts={recharts} />
      <LineChartReferenceLines recharts={recharts} />
      <CustomizedDotLineChart recharts={recharts} />
      <CustomizedLabelLineChart recharts={recharts} />
      <MultiSeriesLineChart recharts={recharts} />
      <SynchronizedLineChart recharts={recharts} />
      <LineChartConnectNulls recharts={recharts} />
    </section>
  )
}
