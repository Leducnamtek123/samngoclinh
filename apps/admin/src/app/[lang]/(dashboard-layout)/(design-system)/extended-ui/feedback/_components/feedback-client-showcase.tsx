  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
      <NotificationsSection
        ...
        addShowcaseToast={addShowcaseToast}
      />
      <ToastSection addShowcaseToast={addShowcaseToast} />
      <EmptyStatesSection addShowcaseToast={addShowcaseToast} />
      <LoadingSection />
      <PlaceholdersSection />
      <ErrorStatesSection addShowcaseToast={addShowcaseToast} />
      <ConfirmationSection addShowcaseToast={addShowcaseToast} />
      <ProgressSection />
...
function NotificationsSection({
  ...
  addShowcaseToast: SectionProps["addShowcaseToast"]
}) {
...
function ToastSection({ addShowcaseToast }: SectionProps) {
...
function EmptyStatesSection({ addShowcaseToast }: SectionProps) {
  return (
...
function ErrorStatesSection({ addShowcaseToast }: SectionProps) {
  return (
    <Card className="shadow-sm">
      <CardHeader>
...
function ConfirmationSection({ addShowcaseToast }: SectionProps) {
