      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Tổng quan hiệu suất hoạt động kinh doanh, tình hình canh tác nông
            trại sâm Ngọc Linh toàn hệ thống.
          </p>
        </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <AlertTitle className="font-bold text-sm">
                Yêu cầu xác minh danh tính đang chờ duyệt
              </AlertTitle>
              <AlertDescription className="text-xs text-amber-700">
                Có{" "}
                <strong>
                  {stats.totalPendingApprovals} yêu cầu xác thực KYC
                </strong>{" "}
                từ người dùng mới đăng ký chưa được phê duyệt.
              </AlertDescription>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-between border rounded-xl p-6 bg-slate-50 dark:bg-slate-900 border-slate-200 shadow-sm dark:border-slate-800">
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Các thao tác xử lý nghiệp vụ chính của Admin
            </p>
            <div className="grid grid-cols-2 gap-3">
              <Link href="/pages/gardens">
                <Button
                  variant="outline"
                  className="w-full justify-start gap-2 hover:bg-white bg-slate-100/50"
                >
              ...
              <Link href="/pages/contracts">
                <Button
                  ...
                  className="w-full justify-start gap-2 hover:bg-white bg-slate-100/50"
                >
                  <FileText className="h-4 w-4 text-amber-600" /> Hợp đồng Điện
                  tử
                </Button>
              </Link>
              <Link href="/pages/orders">
                <Button
                  ...
                  className="w-full justify-start gap-2 hover:bg-white bg-slate-100/50"
                >
                  <ShoppingCart className="h-4 w-4 text-blue-600" /> Đơn đặt
                  hàng
                </Button>
              </Link>
