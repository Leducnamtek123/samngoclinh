...
export const coreBenefitsData: CoreBenefitType[] = [
  {
    ...
    description:
      "Sâm Ngọc Linh Admin equips developers with the latest tools to rapidly build scalable, modern dashboards with less friction.",
    points: [
  ...
  },
  {
    ...
    description:
      "With customizable themes and built-in accessibility, Sâm Ngọc Linh Admin adapts seamlessly to your team’s needs and user diversity.",
    points: [
  ...
  },
  {
    ...
    description:
      "Sâm Ngọc Linh Admin includes essential, production-ready features like authentication, form validation, and rich data components.",
    points: [
