...
> = {
    [EnumAppEnvironment.local]: {
        ...
        promotionCampaigns: [
            {
                ...
                plantCode: 'plant-1y',
                metadata: { source: 'noangsam.com/campaigns/free-tree' },
            },
        ],
        contentArticles: [
            {
                ...
                body: 'Sự ra đời của ứng dụng Sâm Ngọc Linh đã thu hút sự quan tâm của nhiều cơ quan báo chí...',
                status: 'published',
                sortOrder: 1,
            },
            {
                ...
                body: 'Ngày 6/12, ứng dụng Sâm Ngọc Linh do Công ty Cổ phần iWE Homes phát triển...',
                status: 'published',
                sortOrder: 2,
            },
            {
        ...
        businessProfile: {
            ...
            gender: 'female',
            verified: true,
            metadata: { source: 'noangsam.com/profile' },
        },
    },
